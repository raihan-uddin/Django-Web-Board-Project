...
class MyAccountTestCase(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username=self.username, email='raihan@gmail.com', password=self.password)
...
class SuccessfulMyAccountTests(MyAccountTestCase):
    ...
    def test_data_changed(self):
        ...
        self.assertEquals('raihan', self.user.first_name)
        self.assertEquals('uddin', self.user.last_name)
        self.assertEquals('raihan@gmail.com', self.user.email)
